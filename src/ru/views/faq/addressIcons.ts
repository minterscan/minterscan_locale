export default {
  title: 'Иконки аккаунтов',
  disclaimer: `
    На Minterscan каждый адрес имеет свою иконку,
    в зависимости от баланса кошелька
  `,
  text0: `<b>Дельфин</b> – 100 и более миллионов BIP, то есть 1% сети Minter и более!`,
