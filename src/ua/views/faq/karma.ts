export default {
  ...
  disclaimer: `
    ...
    Для реализации механизма кармирования все валидаторы получили карму от команды Minter.
  `,
  text0: `
    Передача кармы от валидатора монете осуществляется валидатором путем отправки транзакции:
    <ul>
