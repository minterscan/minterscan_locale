...
exports.default = {
    ...
    text1: `
    <p>
      🍃<b> Minterscan</b> — это самый популярный эксплорер сети Minter.
      <br>
  ...
  `,
    title2: 'В Telegram',
    text2: `
    <p>🍃<b> Minterscan</b> в Telegram — это качественные публикации на акутальные темы.</p>
    <p>
      <a href="https://t.me/minterscan" taget="_blank">Русскоязычный канал</a> — 
      это <b>900</b> живых подписчиков, охват одного поста ~ <b>1 900</b>, ERR ~ <b>200%</b>.
      ...
      это <b>80</b> живых подписчиков, охват одного поста ~ <b>160</b>, ERR ~ <b>140%</b>.
      Актуальная статистика доступна на 
