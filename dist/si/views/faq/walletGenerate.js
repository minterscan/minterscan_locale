...
exports.default = {
    title: 'Minter Wallets Generator',
    text0: `
    <p>
  ...
  `,
    ...
    <p>
      ...
      Generating multiple wallets in one click.
    </p>
  `,
    text2: `
    <p>
      ...
      <ul>
        <li>Generating seed phrases</li>
        <li>Manual addresses export</li>
        <li>Export addresses in CSV format</li>
        <li>Checking generated wallets on Minterscan</li>
      </ul>
    </p>
    <p>
    ...
    <p>
      ...
      Despite the fact that the code is open and performs only one function - generating seed-phrases.
    ...
    <p>
      <ul>
        <li>
          ...
          <a href="https://github.com/minterscan/minter_wallet_generate" target="_blank">our Github profile</a>.
          We consciously do not make online version to eliminate the possibility of phishing.
        </li>
        <li>
          Use an up-to-date browser without any extensions installed.
